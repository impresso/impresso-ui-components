 ...
 */
export interface LogoImpressoAppProps {
 ...
 * ```
 */
const props = withDefaults(defineProps<LogoImpressoAppProps>(), {
  ...
  >
    ...
    >
      ...
      <path
        ...
        stroke-width="0"
      />
      <rect width="27.17" height="2" :fill="props.color" stroke-width="0" />
      <rect
        x="32.38"
        width="69.94"
        height="2"
