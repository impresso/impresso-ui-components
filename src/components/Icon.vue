<template>
  <svg :width="width * scaleValue" :height="height * scaleValue" :viewBox="computedSvgViewbox"
    :class="{ Icon: true, ['Icon_' + name]: true }">
    <g>
      <path v-for="path in computedPaths" :key="path.d" :d="path.d" :style="coerceStyleType(path.style)"
