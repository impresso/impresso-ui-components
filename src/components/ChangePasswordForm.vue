<template>
  <form @submit.prevent="submitForm" class="password-change-form">
    ...
    <div class="form-group">
      ...
      <div class="password-field">
        <b-form-input
          ...
          :class="{
            ...
            'border-success':
              !v$.currentPassword.$error && v$.currentPassword.$dirty,
          }"
      ...
      >
        <p
          v-for="(error, key) in v$.currentPassword.$errors"
          :key="key"
          class="error-message"
        >
          {{ error.$message }}
    ...
    <div class="form-group">
      ...
      >
        <ul class="list-unstyled m-0 text-muted small">
          ...
          <li
            class="requirement"
            :class="{ 'requirement-met': formData.newPassword.length >= 8 }"
          >
          ...
          <li
            class="requirement"
            :class="{
              'requirement-met': /[^A-Za-z0-9]/.test(formData.newPassword),
            }"
          >
      ...
      <div v-if="v$.newPassword.$error" id="newPasswordError" role="alert">
        <span
          v-for="(error, key) in v$.newPassword.$errors"
          :key="key"
          class="error-message mr-1"
        >
          {{ error.$message }}
        </span>
      </div>
    ...
    <div class="form-group">
      ...
      <div class="password-field">
        <b-form-input
          ...
          :class="{
            ...
            'border-success':
              !v$.repeatNewPassword.$error && v$.repeatNewPassword.$dirty,
          }"
      ...
      <div
        v-if="v$.repeatNewPassword.$error"
        id="repeatPasswordError"
        role="alert"
      >
        <p
          v-for="(error, key) in v$.repeatNewPassword.$errors"
          :key="key"
          class="error-message"
        >
          {{ error.$message }}
